...
func (c *registerServiceClient) Register(ctx context.Context, in *ReqRegister, opts ...grpc.CallOption) (*ResRegister, error) {
...
type RegisterServiceServer interface {
	Register(context.Context, *ReqRegister) (*ResRegister, error)
...
func (UnimplementedRegisterServiceServer) Register(context.Context, *ReqRegister) (*ResRegister, error) {
...
func _RegisterService_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegisterServiceServer).Register(ctx, req.(*ReqRegister))
	}
...
var RegisterService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/user-service/proto/register.proto",
}
