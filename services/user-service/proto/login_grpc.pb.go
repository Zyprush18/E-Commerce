...
func (c *loginServiceClient) Login(ctx context.Context, in *ReqLogin, opts ...grpc.CallOption) (*ResLogin, error) {
...
func (UnimplementedLoginServiceServer) Login(context.Context, *ReqLogin) (*ResLogin, error) {
...
func _LoginService_Login_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LoginServiceServer).Login(ctx, req.(*ReqLogin))
	}
...
var LoginService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "services/user-service/proto/login.proto",
}
